...
extension Item
{
    ...
    @NSManaged public var ordered_quantity: Int32
    @NSManaged public var product_item_id: Int32
    @NSManaged public var quantity: Int32
    @NSManaged public var transient_identifier: String?
    @NSManaged public var cancelled_purchase_orders: Purchase_Order?
    @NSManaged public var puchase_orders: Purchase_Order?
}
